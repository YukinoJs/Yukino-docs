...
- **Blog**: Check out our blog for updates and announcements. The latest post can be found in `blog/2023-01-01-welcome.mdx`.
- **Docs**: The documentation is organized into sections:
  - **Introduction**: An overview of the project is available in `docs/intro.mdx`.
  - **API**: Detailed API documentation can be found in `docs/api/index.mdx`.
